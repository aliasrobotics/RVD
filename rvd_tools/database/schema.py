...
SCHEMA = {
    ...
    "cwe": {
        ...
        # 'nullable': True,
        "regex": "^CWE-[0-9]*.*$|^None$",
        "default_setter": lambda doc: "None",
    },
    "cve": {
        "required": True,
        "type": "string",
    ...
    "system": {"required": True, "type": "string", "default_setter": lambda doc: ""},
    "vendor": {
        "required": True,
        "type": "string",
        "nullable": True,
    ...
    "severity": {
        ...
        "schema": {
            ...
            "rvss-vector": {"type": "string", "required": True,},
            "severity-description": {"type": "string", "required": True,},
            "cvss-score": {
                "oneof": [{"type": "string"}, {"type": "number"}],
                "regex": "^None$",
                "min": 0,
            ...
            "cvss-vector": {"type": "string", "required": False,},
        },
    },
    "links": {
        "required": False,
    ...
    "flaw": {
        ...
        "schema": {
            "phase": {
                ...
                "default_setter": lambda doc: "unknown",
            },
            "specificity": {
                "required": True,
                "type": "string",
            ...
            "subsystem": {
                "type": "string",
                "required": True,
                "regex": "^(sensing|actuation|communication|cognition|UI|power).*$|^N/A$|.*",
            ...
            "detected-by-method": {
                ...
                "allowed": [
                    ...
                    "assertions",
                    "runtime detection",
                    "runtime crash" "testing violation",
                    "testing static",
                    "testing dynamic",
                    "N/A",
                ],
            ...
            "issue": {"type": "string", "default_setter": lambda doc: "",},
            "reproducibility": {
                "type": "string",
                "required": True,
                "default_setter": lambda doc: "",
